...
public class AntiBan {
    public int ANTIBAN_RATE = 35; // This is the frequency rate for anti-ban actions (in % terms - 100% = frequent, 0% = never
    ...
    public int MIN_WAIT_BETWEEN_EVENTS = 25; // In seconds
